...
// Componente DraggableCardContainer
function DraggableCardContainer({ children, className = "" }) {
  return (
...
// Componente DraggableCardBody
function DraggableCardBody({ children, className = "" }) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-lg p-4 select-none">
        {children}
      </div>
    </div>
  );
...
export default function DraggableCardDemo() {
  ...
  return (
    <DraggableCardContainer className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gray-50 dark:bg-gray-950">
